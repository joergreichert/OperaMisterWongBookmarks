...
public class Activator extends AbstractUIPlugin {
	...
	public void start(BundleContext context) throws Exception {
		super.start(context);
		plugin = this;
		operaInjector = Guice.createInjector(Modules2.mixin(new SharedModule(), new OperaDSLRuntimeModule(), new OperaDSLUiModule(this), new BookmarkFormsModule()));
		misterWongInjector = Guice.createInjector(Modules2.mixin(new SharedModule(), new MisterWongDslRuntimeModule(), new MisterWongDslUiModule(this), new BookmarkFormsModule()));
	}
